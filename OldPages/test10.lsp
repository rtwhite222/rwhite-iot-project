    ...
    <div class="container" >
    	<div class="row" >
            ...
            <div class="tab" id = "deviceSettings">
                <button class="tablinks" onclick="openInfo(event, 'DeviceInfo')" id="defaultOpen">Device Info</button>
                <button class="tablinks" onclick="openInfo(event, 'ChangeSettings')">Edit Device Settings</button>
